...
public class Checkout extends HttpServlet {
    ...
    private void saveOrders(Session session, Transaction transaction, User user, Address address, JsonObject responseJsonObject) {
        try {
            ...
            String merchant_id = "1221152";
            String formatted_amount = new DecimalFormat("0.00").format(amount);
            String currency = "LKR";
            String merchantSecret = "MzUwNTM3ODA3NzI3OTAxNTI2MTkyNzY5MzUyNTI5MzI0OTEwNDYxMg=="; //**
            ...
            payhere.addProperty("phone", "0771791684");
            payhere.addProperty("address", "19/1B, Walawwatta, Gangoda");
            payhere.addProperty("city", "Yatawatta");
